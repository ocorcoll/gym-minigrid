...
class DoorKeyEnv5x5(DoorKeyEnv):
    def __init__(self, agent_view_size):
        super().__init__(size=5, agent_view_size=agent_view_size)

class DoorKeyEnv6x6(DoorKeyEnv):
    def __init__(self, agent_view_size):
        super().__init__(size=6, agent_view_size=agent_view_size)

class DoorKeyEnv16x16(DoorKeyEnv):
    def __init__(self, agent_view_size):
        super().__init__(size=16, agent_view_size=agent_view_size)
