...
COLORS = {
    ...
    'orange': np.array([255, 69, 0]),
    'brown': np.array([210, 105, 30]),
    'pink': np.array([255, 0, 247]),
...
class WorldObj:
    ...
    def encode(self):
        ...
        if self.can_contain():
            state = OBJECT_TO_IDX[self.contains.type] if self.contains else 1
    ...
    def decode(type_idx, color_idx, state):
        ...
        is_open = state == STATE_TO_IDX['open']
        is_locked = state == STATE_TO_IDX['locked']
